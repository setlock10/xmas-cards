...
function Greeting(){
   ...
   // const moveTimer = useRef(0);
    ...
    function renderHat(){
        ...
        refHat.current.classList.add("animate-blink")
    }
    ...
    function checkHat(){
        ...
        if((characterTop<250)&&((characterLeft>530)&&(characterLeft<670))){
            //console.log("true");
            //setHasHat(true);
            ...
            refHat.current.classList.add("hidden")
            refTree.current.classList.add("tree-star")
            //debugger
